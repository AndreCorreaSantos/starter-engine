...
32:                                               ; preds = %29
  %33 = extractvalue { ptr, ptr, i64, [1 x i64], [1 x i64] } %6, 1
...
define void @main() {
  %1 = call { ptr, ptr, i64 } @add()
  %2 = extractvalue { ptr, ptr, i64 } %1, 1
  %3 = load double, ptr %2, align 8
  %4 = call i32 (ptr, ...) @printf(ptr @frmt_spec, double %3)
  ret void
}
