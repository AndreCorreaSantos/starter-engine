scftocalyx_out.mlir:1:1: error: Module contains multiple functions, but no top level function was set. Please see --top-level-function
module attributes {calyx.entrypoint = "main"} {
^
scftocalyx_out.mlir:1:1: note: see current operation: 
"builtin.module"() ({
